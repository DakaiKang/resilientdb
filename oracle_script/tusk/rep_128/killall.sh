...
for ip in ${iplist[@]};
do
 scp -i ~/.ssh/dakai_dev.pem /home/ubuntu/resilientdb/bazel-bin/application/tusk/kv_server_performance ubuntu@${ip}:/home/ubuntu &
scp -i ~/.ssh/dakai_dev.pem /home/ubuntu/resilientdb/oracle_script/tusk/rep_128/server.config ubuntu@${ip}:/home/ubuntu &
scp -i ~/.ssh/dakai_dev.pem /home/ubuntu/resilientdb/oracle_script/tusk/rep_128/cert/node_${idx}.key.pri ubuntu@${ip}:/home/ubuntu/pbft_cert/ &
scp -i ~/.ssh/dakai_dev.pem /home/ubuntu/resilientdb/oracle_script/tusk/rep_128/cert/cert_${idx}.cert ubuntu@${ip}:/home/ubuntu/pbft_cert/ &
	((count++))
	((count++))
	((count++))
	((count++))
