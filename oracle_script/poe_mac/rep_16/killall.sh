...
for ip in ${iplist[@]};
do
 scp -i ${key} /home/ubuntu/resilientdb/bazel-bin/application/poe_mac/kv_server_performance ubuntu@${ip}:/home/ubuntu &
scp -i ${key} /home/ubuntu/resilientdb/oracle_script/poe_mac/rep_16/server.config ubuntu@${ip}:/home/ubuntu &
scp -i ${key} /home/ubuntu/resilientdb/oracle_script/poe_mac/rep_16/cert/node_${idx}.key.pri ubuntu@${ip}:/home/ubuntu/pbft_cert/ &
scp -i ${key} /home/ubuntu/resilientdb/oracle_script/poe_mac/rep_16/cert/cert_${idx}.cert ubuntu@${ip}:/home/ubuntu/pbft_cert/ &
	((count++))
	((count++))
	((count++))
	((count++))
